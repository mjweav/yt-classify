...
class YTClassifier:
    ...
    def compute_umbrella_vectors(self) -> Dict[str, Dict[str, float]]:
        ...
        # Enhanced seed texts based on successful real examples from high-quality classifications
        umbrella_seeds = {
            "News & Commentary": "news politics opinion analysis commentary current events breaking journalism reporter media broadcast editorial debate policy government election campaign democracy brian tyler cohen dw news political analysis progressive news",
            "Science & Technology": "science technology research innovation discovery engineering computer software programming artificial intelligence machine learning data robotics physics chemistry biology laboratory experiment hypothesis theory scientific method matthew berman ai art generative art futurism chatgpt",
            ...
            "Education & Learning": "education learning study course school university knowledge teaching professor student classroom lecture curriculum degree program academic research library textbook homework assignment nick stephenson bestselling author fiction sci-fi",
            "Arts & Design": "art design creative drawing painting craft visual artistic gallery museum sculpture architecture graphic design illustration portfolio exhibition aesthetic composition color theory architecture photography interior photographer photography education",
            "DIY & Making": "diy project build make craft tutorial repair woodworking metalworking fabrication construction renovation improvement handmade homemade workshop tools technique craftsmanship house improvements professional carpenter pavement repair",
            ...
            "Auto & Vehicles": "car vehicle automobile truck motorcycle engine repair maintenance mechanic garage automotive industry transportation driving road highway traffic safety performance modification denys davydov ukraine roads",
            "Aviation & Flight": "airplane aircraft flight aviation pilot airport space drone helicopter airline commercial military flight simulator aerial navigation cockpit takeoff landing airspace pilot kelsey boeing 747 flight simmer drone canada",
